...
variant_for_slice()
{
  ...
  "MetricaAdapterReflection.xcframework/ios-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  "VQSwiftProtobuf.xcframework/ios-arm64_armv7")
    echo ""
    ;;
  "VQSwiftProtobuf.xcframework/ios-arm64_i386_x86_64-simulator")
    echo "simulator"
    ;;
  esac
}
...
install_xcframework "${PODS_ROOT}/Varioqub/VQSwiftProtobuf.xcframework" "Varioqub/VQSwiftProtobuf" "framework" "ios-arm64_armv7" "ios-arm64_i386_x86_64-simulator"
