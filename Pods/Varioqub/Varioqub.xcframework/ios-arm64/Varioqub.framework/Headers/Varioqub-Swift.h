...
@property (nonatomic, copy) NSDictionary<NSString *, NSString *> * _Nonnull clientFeatures;
...
SWIFT_CLASS("_TtC8Varioqub15VQDefaultLogger")
@interface VQDefaultLogger : NSObject <VQLoggerDestination>
@property (nonatomic) enum VQLogLevel level;
- (BOOL)isAcceptedWithModule:(NSString * _Nonnull)module_ level:(enum VQLogLevel)level SWIFT_WARN_UNUSED_RESULT;
- (void)logWithModule:(NSString * _Nonnull)module_ level:(enum VQLogLevel)level message:(NSString * _Nonnull)message;
- (void)logWithModule:(NSString * _Nonnull)module_ level:(enum VQLogLevel)level error:(NSError * _Nonnull)error;
...
@protocol VQIdProvider <NSObject>
...
@protocol VQReporter <NSObject>
@optional
- (void)setExperiments:(NSString * _Nonnull)experiments;
- (void)setTriggeredTestIds:(NSSet<NSNumber *> * _Nonnull)testIds;
@end
...
- (void)initializeWithApiKey:(NSString * _Nonnull)apiKey config:(VQConfig * _Nonnull)config idProvider:(id <VQIdProvider> _Nullable)idProvider reporter:(id <VQReporter> _Nullable)reporter;
@end
